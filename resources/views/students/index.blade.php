    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col col-md-6">
                <a href="{{ route('students.create') }}" class="btn btn-success btn-sm float-end"></a>
            </div>
        </div>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                            ...
                            <td>
                                <form method="post" action="{{ route('students.destroy', $row->StudentID) }}">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ route('students.show', $row->StudentID) }}" class ="btn btn-primary">
                                    <a href="{{ route('students.destroy', $row->StudentID) }}" class = "btn btn-warning">
